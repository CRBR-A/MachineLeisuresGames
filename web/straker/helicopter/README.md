...
<img width="300" height="206" alt="" src="screenshot.png">

## Further Exploration

- Score / Distance
  - As the helicopter moves right, the score / distance should increase. Use [context.fillText()](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/fillText) to display the score / distance to the screen
